...
public class PursueTargetState : State
{
    ...
    public override State Tick(EnemyManager enemyManager, EnemyStats enemyStats, EnemyAnimatorManager enemyAnimatorManager)
    {
        ...
        {
            enemyAnimatorManager.animator.SetFloat(DarkSoulsConsts.VERTICAL, enemyStats.walkSpeed, 0.1f, Time.deltaTime);
            return this;
        }

        if (distanceFromTarget > enemyManager.maximumAggroRadius)
        {
            enemyAnimatorManager.animator.SetFloat(DarkSoulsConsts.VERTICAL, enemyStats.runSpeed, 0.1f, Time.deltaTime);
            return this;
        }
